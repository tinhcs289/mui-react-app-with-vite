import { Text, TextProps } from "@/components/form/input/Text";
import newGuid from "@/helpers/string-helpers/newGuid";
import type { AnyObject, RHFInputProps, RHFRenderInput, Tag } from "@/types";
...
export type TextTagsProps<T extends AnyObject = AnyObject> = Omit<
  TextProps,
...
export function TextTags<T extends AnyObject = AnyObject>({
  value,
  onChange,
  placeholder,
  InputProps,
...
export function RHFTextTags(props: RHFTextTagsProps) {
  const {
    name,
    control,
    rules,
